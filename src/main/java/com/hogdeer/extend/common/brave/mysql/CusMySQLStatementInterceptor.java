/*
 * @(#)CusMySQLStatementInterceptor.java 2017年9月29日 下午3:10:21
...
/**
 * mysql拦截器
 * <p>File：CusMySQLStatementInterceptor.java</p>
 * <p>Title: </p>
 * <p>Description:</p>
 * <p>Copyright: Copyright (c) 2017年9月29日 下午3:10:21</p>
 * <p>Company: cargogm.com</p>
 * @author 施建波
 * @version 1.0
 */
public class CusMySQLStatementInterceptor implements StatementInterceptorV2{
    ...
    public ResultSetInternalMethods preProcess(final String sql, final Statement interceptedStatement, final Connection connection) throws SQLException {
        ClientTracer clientTracer = CusMySQLStatementInterceptor.clientTracer;
        if (clientTracer != null) {
            final String sqlToLog;
            if (interceptedStatement instanceof PreparedStatement) {
                beginTrace(clientTracer, connection);
            }
        }
        return null;
    }
    ...
    private void beginTrace(final ClientTracer tracer, final Connection connection) throws SQLException {
        try {
